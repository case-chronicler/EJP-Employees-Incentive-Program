...
console.log(props.invite_link_is_valid);
	...
	<GuestLayout>
		...
		>
			...
			<div class="text-base font-semibold leading-6 text-gray-800">
				...
				<p v-else>
					It seems you were not invited by E-Justice Project. Only invited users
					can complete their registration here. Please use the invite link sent
					to your mailbox
				</p>
			</div>
		</div>
